...
```
git clone ssh://git@repo.gaul.csd.uwo.ca:7999/cs2212_w2016/jtayl294.git
```

*Remember*: do *not* develop on the `master`.  Make sure you only develop on
the `dev` branch.  To submit your assignment, open a pull request to merge
your changes on `dev` back into the `master` branch.
